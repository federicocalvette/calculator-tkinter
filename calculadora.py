from tkinter import *
from funciones_auxiliares import Ops

# Creo la ventana
ventana = Tk()
ventana.title("Calculadora")
ventana.config(bg='dark sea green')

# Entrada en la ventana
entrada_txt = Entry(ventana, font=("Arial 21"))
entrada_txt.grid(row=0, column=0, columnspan=4, padx=11, pady=5)

# Creo objeto de Ops -> Operaciones
fa = Ops(entrada_txt)
...
# Fila 1
boton_parentesis_izq.grid(row=1, column=0, padx=5, pady=5)
boton_parentesis_der.grid(row=1, column=1, padx=5, pady=5)
boton_division.grid(row=1, column=2, padx=5, pady=5)
...
boton_es_igual.grid(row=5, column=3, padx=5, pady=5)
